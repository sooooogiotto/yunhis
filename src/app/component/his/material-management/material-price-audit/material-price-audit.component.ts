...
@Component({
  selector: 'app-material-price-audit',
  templateUrl: './material-price-audit.component.html',
  styleUrls: ['./material-price-audit.component.scss', '../../../common/form.scss', '../../../common/table.scss', '../../../common/page.scss']
})
