...
@Component({
  selector: 'app-material-apply',
  templateUrl: './material-apply.component.html',
  styleUrls: ['./material-apply.component.scss', '../../../common/form.scss', '../../../common/table.scss', '../../../common/page.scss']
})
